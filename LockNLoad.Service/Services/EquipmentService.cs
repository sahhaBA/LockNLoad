...
{
    public class EquipmentService : BaseCRUDService<EquipmentResponse, Equipment, EquipmentSearchObject, EquipmentInsertRequest, EquipmentUpdateRequest>, IEquipmentService
    {
        public EquipmentService(LockNLoadContext context, IMapper mapper)
            : base(context, mapper)
        {
        }
