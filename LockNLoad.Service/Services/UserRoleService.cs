...
{
    public class UserRoleService : BaseCRUDService<UserRoleResponse, UserRole, UserRoleSearchObject, UserRoleInsertRequest, UserRoleUpdateRequest>, IUserRoleService
    {
        public UserRoleService(LockNLoadContext context, IMapper mapper)
            : base(context, mapper)
        {
        }
